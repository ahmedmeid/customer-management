...
@WithMockUser
@EmbeddedKafka
class CustomerManagementKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/customer-management-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/customer-management-kafka/consume")
